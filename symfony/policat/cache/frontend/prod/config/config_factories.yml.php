...
// date: 2016/06/07 17:23:35
  ...
  'cache_dir' => 'D:\\project\\upwork\\symfony\\policat-master\\cache\\frontend\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'D:\\project\\upwork\\symfony\\policat-master\\apps\\frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'policatRouting');
      $cache = null;
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'policatSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('policat'),
  ...
  {
    $class = sfConfig::get('sf_factory_view_cache', 'sfTaggingCache');
    $cache = new $class(sfConfig::get('sf_factory_view_cache_parameters', array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'D:\\project\\upwork\\symfony\\policat-master\\cache\\frontend\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'D:\\project\\upwork\\symfony\\policat-master\\apps\\frontend/template',
  'storage' => 
  array (
    ...
    array (
      'automatic_cleaning_factor' => 0,
      'cache_dir' => 'D:\\project\\upwork\\symfony\\policat-master\\cache/sf_tag_cache',
    ),
  ),
  'logger' => 
  array (
    'class' => 'sfNoCacheTagLogger',
    'param' => 
    array (
      'file' => 'D:\\project\\upwork\\symfony\\policat-master\\log/cache_prod.log',
      'format' => '%char% %microtime% %key%%EOL%',
    ),
  ),
)));
    $this->factories['viewCacheManager'] = new sfViewCacheTagManager($this, $cache, array (
