...
function aws_signed_request($region, $params) {
	...
	$public_key = "AKIAJJQJX7Z6T3EU3I5Q";

	$private_key = "O27svOdxYviOla+xW6zdXQ9Y6mBlJ7AnfyoHuBsd";
	...
	$params["AssociateTag"] = "disecent-20"; // Put your Affiliate Code here
